    ...
    return (
              <div className="col pane" id="sidePane">
                {this.props.pane.top === 'images' &&
                  <SOptions hi={this.state.height} actions={this.togglePaneT} loc='top' />
                }
                {this.props.pane.top === 'text' &&
                  <SOptions hi={this.state.height} loc='top' actions={this.togglePaneT} />
                }
                {this.props.pane.bottom === 'networks' &&
                  <SOptions hi={this.state.height} actions={this.togglePaneB} loc='bottom' />
                }
                {this.props.pane.bottom === 'text' &&
                  <SOptions hi={this.state.height} loc='bottom' actions={this.togglePaneB} />
                }
